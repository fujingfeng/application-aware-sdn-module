...
class config_retrieval:
    ...
    def get_gridftp_directory_priority(self):
        ...
        """
        return self.config.get('GridFTP', 'gridftp_directory_priority').split(self.delimiter)
    ...
    def get_qos_info(self, application):
        ...
        """
        queue_num = self.config.get(application, application.lower()+'_qos_queues_num')
        queue_start_id = self.config.get(application, application.lower()+'_qos_queues_start_id')
    ...
    def get_qos_bandwidth(self, application):
        ...
        The result is application dependent, can be HTCondor, GridFTP, General...
        """
        qos_bandwidth = self.config.get(application, application.lower()+'_qos_bandwidth')
